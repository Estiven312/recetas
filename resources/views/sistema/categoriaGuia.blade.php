                ...
                <div class="row">
                    <div class="col-3">
                        <div class="contenedor">
                            <a href="/sistema/categoria/guia/nueva"> Nueva Categoria <img src="{{ asset('/img/mas.png') }}" alt="nueva"></a>
                        </div>
                    </div>
                    <div class="col-9">
                            ...
                            <tbody>
                                @foreach ($cate as $categoria)
                                    <tr>
                                        ...
                                        <td><a href="/sistema/categoria/guia/nueva/{{$categoria['id']}}"><img src="{{ asset('/img/editar.png') }}" alt="editar"
                                                    width="25px"></a></td>
